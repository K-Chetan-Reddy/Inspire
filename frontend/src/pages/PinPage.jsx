            ...
            <div className="bg-white rounded-lg shadow-lg flex flex-wrap w-full max-w-4xl">
              ...
              <div className="w-full md:w-1/2 p-6 flex flex-col ">
                ...
                {edit && (
                  <button
                    style={{ width: "200px" }}
                    className="bg-blue-500 text-white py-1 px-3 mt-2 mb-2"
                  ...
                  <div className="flex items-center justify-between border-b pb-4 mb-4">
                    <div className="flex items-center">
                      <Link to={`/user/${pin.owner._id}`}>
                        <div className="rounded-full h-12 w-12 bg-stone-400 flex items-center justify-center">
                ...
                <div className="flex items-center mt-4">
                  <div className="rounded-full h-12 w-12 bg-stone-400 flex items-center justify-center mr-4">
                    <span className="font-bold capitalize">
